public class GregorianDate {
    ...
    public GregorianDate() {  /*Default constructor*/  /*He would Prefer that you set the 1970 date in the default constructor*/
    ...
    public boolean isLeapYear() {
        ...
        return((year % 4 == 0 && year % 100 != 0) || (year % 100 == 0 && year % 400 == 0));  /*FIX MY LOGIC HERE*/
    }
